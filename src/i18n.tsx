...
const dictionaries: Record<Lang, Dict> = {
  es: {
    ...
    'home.what_is.p1': 'Goals System es un sistema moderno y seguro de gestión financiera personal que almacena y administra tu información más sensible de manera local.',
    'home.what_is.p2': 'Diseñado para personas con altas exigencias de gestión de datos personales seguros, Goals System te permite registrar ingresos y gastos, crear categorías personalizadas, gestionar múltiples tarjetas y establecer presupuestos mensuales.',
    'home.what_is.p3': 'Toda tu información se guarda de forma segura en tu dispositivo, sin necesidad de conexión a servicios en la nube, garantizando tu privacidad y control total sobre tus datos financieros.',
  ...
  en: {
    ...
    'home.what_is.p1': 'Goals System is a modern and secure personal financial management system that stores and manages your most sensitive information locally.',
    'home.what_is.p2': 'Designed for people with high demands for secure personal data management, Goals System allows you to record income and expenses, create custom categories, manage multiple cards, and set monthly budgets.',
    'home.what_is.p3': 'All your information is stored securely on your device, without the need for a cloud connection, guaranteeing your privacy and full control over your financial data.',
